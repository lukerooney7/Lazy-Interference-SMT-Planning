...
valid_configs = {
    ...
    "lazyForall":  (EncoderLazyForall, SMTSearch, grounded_encoders_default_compilation_list),
    "lazyExists":  (EncoderLazyExists, SMTSearch, grounded_encoders_default_compilation_list),
